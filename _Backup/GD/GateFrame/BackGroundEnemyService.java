...
public class BackGroundEnemyService implements Runnable{
	...
	public void run() {
		...
		while (enemy.getEnemyState() == EnemyState.LIVE) {
			...
			Color leftColor = new Color(image.getRGB(enemy.getX()-20, enemy.getY()+55));
			Color rightColor = new Color(image.getRGB(enemy.getX()+110+22, enemy.getY()+55));
			
			//-1 -1 = -2일때 바닥이 흰색
			int bottomColor = image.getRGB(enemy.getX() + 10, enemy.getY()+100) //흰색일때 -1
					 +image.getRGB(enemy.getX() +110 - 10, enemy.getY()+100);//흰색일때 -1
