...
public class Player extends JLabel implements Movable {
	...
	private ImageIcon playerStopR, playerStopL;
	private ImageIcon playerAttackR, playerAttackL;

	private int direction; // test용 1이 왼쪽 2가 오른쪽
	...
	private void initObject() {
		playerR = new ImageIcon("image/걷기(오른쪽).gif");
		playerL = new ImageIcon("image/걷기(왼쪽).gif");
		playerStopR = new ImageIcon("image/기본(오른쪽).png");
		playerStopL = new ImageIcon("image/기본(왼쪽).png");
		playerAttackR = new ImageIcon("image/공격(오른쪽).gif");
		playerAttackL = new ImageIcon("image/공격(왼쪽).gif");
	}
	...
	private void initSetting() {
		...
		setIcon(playerStopR); // 처음에 오른쪽을 보고 있음
